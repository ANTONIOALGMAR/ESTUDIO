...
import useMediaQuery from '../hooks/useMediaQuery'; // Corrigindo o caminho da importação
...
const Dashboard = () => {
  ...
  // Hook para verificar se a tela é pequena (abaixo de 768px)
            ...
            {filteredBookings.map((booking) => (
              <Card key={booking._id} className="mb-3" bg="dark" text="white">
                <Card.Body>
                  ...
                  <hr />
                  <Row className="mb-2">
                    <Col xs={4} as="strong">Serviço:</Col>
                    <Col xs={8}>{Array.isArray(booking.service) ? booking.service.join(', ') : booking.service}</Col>
                  </Row>
                  <Row className="mb-2">
                    <Col xs={4} as="strong">Data:</Col>
                    <Col xs={8}>{new Date(booking.date).toLocaleDateString('pt-BR')}</Col>
                  </Row>
                  <Row className="mb-2">
                    <Col xs={4} as="strong">Email:</Col>
                    <Col xs={8}>{booking.email}</Col>
                  </Row>
                  <Row className="mb-2">
                    <Col xs={4} as="strong">Telefone:</Col>
                    <Col xs={8}>{booking.phone}</Col>
                  </Row>
                  <hr />
